...
ssh root@master1.example.com "oc adm policy add-cluster-role-to-user cluster-admin karla"
...
--env="ADMINUSER=admin" --env="ADMINPASSWORD=${REPLPASSWORD}" --env="BASEDOMAIN=$GUID.oslab.opentlc.com" \
