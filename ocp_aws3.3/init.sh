...
echo "ansible-playbook /root/.opentlc_deployer/${COURSE}/ansible/main.yml"   2>&1 | tee -a $LOGFILE
export HOME="/root"
ansible-playbook /root/.opentlc_deployer/${COURSE}/ansible/main.yml   2>&1 | tee -a $LOGFILE
...
API
    ...
    ansible masters[0] -m shell "systemctl restart atomic-openshift-master"
