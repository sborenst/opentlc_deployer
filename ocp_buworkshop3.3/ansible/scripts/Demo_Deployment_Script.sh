...
export DOMAIN="apps-${GUID}.workshops.openshift.com"
...
--env="ADMINUSER=admin" --env="ADMINPASSWORD=${REPLPASSWORD}" --env="BASEDOMAIN=${DOMAIN}" \
--env="MASTERPORT=443" --env="NUMUSERS=5" --image=openshiftdemos/workshop-provisioner:0.14
set +x
